...
import {MAIN_ROUTER, PROD_ROUTER, REACT_APP_API_URL} from "../utils/const";
...
const Music = observer(() => {
    ...
    const [play, {pause, duration, sound}] = useSound(REACT_APP_API_URL + musicOne.trackMp3);
    const playingButton = () => {
        if (isPlaying) {
            pause();
            setIsPlaying(false);
                            ...
                            <button onClick={playingButton} className='absolute flex mt-5 ml-5'>
                                {isPlaying
                                    ...
                                    <svg width="11" height="12" viewBox="0 0 13 14" fill="none"
                                        ...
                                        <path
                                            d="M3.70563 13.1783H1.13576C0.508497 13.1783 0 12.6698 0 12.0426V1.1465C0 0.519239 0.508497 0.0107422 1.13576 0.0107422H3.70563C4.33289 0.0107422 4.84139 0.519239 4.84139 1.1465V12.0426C4.84139 12.6698 4.33289 13.1783 3.70563 13.1783Z"
                                            fill="white"/>
                                        <path
                                            d="M11.8638 13.1676H9.29396C8.6667 13.1676 8.1582 12.6591 8.1582 12.0318V1.13576C8.1582 0.508497 8.6667 0 9.29396 0H11.8638C12.4911 0 12.9996 0.508497 12.9996 1.13576V12.0318C12.9996 12.6591 12.4911 13.1676 11.8638 13.1676Z"
                                            fill="white"/>
                                    </svg>
                                    :
                                    <svg width="11" height="12" viewBox="0 0 11 12" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M1.54678 0.0770397L10.7227 5.50737C11.0925 5.72629 11.0925 6.27371 10.7227 6.49263L1.54678 11.923C1.17689 12.1419 0.714355 11.8682 0.714355 11.4303V0.569666C0.714355 0.13183 1.17665 -0.141878 1.54678 0.0770397Z"
                                            fill="#F1F1F1"/>
                                    </svg>
                                }
                            </button>
