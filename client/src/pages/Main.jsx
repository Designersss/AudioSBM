            ...
            <div className='mt-20'>
                ...
                <div className='grid grid-cols-5 gap-8'>
                    {services.servicesAll.map(service =>
                        <Link to={MAIN_ROUTER} className='flex justify-center items-center bg-[#1B1B1B] h-40 uppercase rounded-xl text-center transition hover:bg-[#2B2B2B]'>
                            <p className='font-semibold text-[12px]'>{service.name}</p>
                        </Link>
                    )}
                </div>
            </div>
            <div>
                <div className='flex items-center mt-8 mb-3 items-center mt-20'>
                        ...
                        <div className='flex mt-2'>
                            <Link to={MAIN_ROUTER}>
                                <svg width="38" height="39" viewBox="0 0 38 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M17.0791 27V19.4994H15.57V16.9146H17.0791V15.3626C17.0791 13.2539 17.9312 12 20.3521 12H22.3676V14.5851H21.1078C20.1654 14.5851 20.103 14.9464 20.103 15.6205L20.0996 16.9143H22.3819L22.1148 19.4991H20.0996V27H17.0791Z" fill="white"/>
                                </svg>
                            </Link>
